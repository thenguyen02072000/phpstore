    ...
    <section class="bg0 p-t-23 p-b-140">
        <div class="container">
            ...
            <div class="flex-w flex-sb-m p-b-52">
                <div class="flex-w flex-l-m filter-tope-group m-tb-10">
                    ...
                    <button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5 how-active1"
                        data-filter=".<?=$final['id']?>"><?=$final['name']?>
                    </button>
                ...
                <div class="dis-none panel-search w-full p-t-10 p-b-15">
                    <div class="bor8 dis-flex p-l-15">
                        <button class="size-113 flex-c-m fs-16 cl2 hov-cl1 trans-04" onclick="product.php">
            ...
            <div class="row isotope-grid">
                ...
                <?php 
				include("partials/connect.php");
				$sql = "SELECT * FROM products WHERE status = 1 LIMIT 16";
                ...
                <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?=$final['category_id']?>">
                    <!-- Block2 -->
                    <div class="block2">
